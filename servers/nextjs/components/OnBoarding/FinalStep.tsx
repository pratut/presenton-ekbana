    ...
    return (
        <div className='fixed top-0 left-0 w-full h-full flex flex-col items-center justify-center'>
            <div className='flex flex-col items-center justify-center'>
                ...
                <img src="/final_onboarding.png" alt="EKbana-AI presentation" className='w-[118px] h-[98px]  object-contain' />
                ...
                <button onClick={handleGoToUpload} className='bg-gradient-to-r from-ekbana-green to-ekbana-blue px-[23px] mt-14 py-[15px]  rounded-[70px] text-white text-lg font-syne font-semibold'>My First Presentation</button>
            </div>
